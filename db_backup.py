...
class DBExecute:
    ...
    def execute2():    
        ...
        TOTAL_REQUESTS = 1500 #entre 1000 e 7000
        MULTIPLIER = 0
        ...
        def make_request(worker_id, target_info):
            ...
            HEADERS = {
                ...
                'priority': 'u=1, i',
                'referer': f'https://hentai2read.com/{target_info["slug"]}/coming-soon/1/', # Referer dinâmico
        ...
        for alvo_atual2 in ALVOS:
            ...
            if alvo_atual['mid'] in ['45432','45050','8988','3032','2815','2169','3596', '10614','2668','14548','4061','2239','5589','4029']:
                UPS_VARIAVEIS = 15000
                if alvo_atual['mid'] in ['45432','2169','45050']:
                    UPS_VARIAVEIS += 20234
            else:
                UPS_VARIAVEIS = 10
